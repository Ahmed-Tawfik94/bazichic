...
--
-- AUTO_INCREMENT for table `document_audios`
--
ALTER TABLE `document_audios`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `document_likes`
--
ALTER TABLE `document_likes`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `doc_keywords`
--
ALTER TABLE `doc_keywords`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `faq_sub_categories`
--
ALTER TABLE `faq_sub_categories`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `generated_otps`
--
ALTER TABLE `generated_otps`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `membersip_plans`
--
ALTER TABLE `membersip_plans`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `paypal_tests`
--
ALTER TABLE `paypal_tests`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
